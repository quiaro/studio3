/* global CKEDITOR, requirejs */

'use strict';

requirejs(['domReady', 'jquery', 'ckeditor', 'pubsub', 'editor/scripts/config', 'editor/scripts/event-bridge', 'css!editor/editor'],
    function(domReady, $, ckeditor, pubsub, config) {


        console.log('Editor LOADED (with dependencies!)');
